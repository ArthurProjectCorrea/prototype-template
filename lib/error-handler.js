...
const KNOWN_ERRORS = {
  ...
  'Não é possível excluir um departamento que possui cargos vinculados':
    'Não é possível excluir um departamento que possui cargos vinculados',
  'Não é possível excluir um cargo que possui usuários vinculados':
    'Não é possível excluir um cargo que possui usuários vinculados',
  'Não é possível excluir um cargo que possui permissões vinculadas':
    'Não é possível excluir um cargo que possui permissões vinculadas',
  'Não é possível excluir uma tela que possui permissões vinculadas':
    'Não é possível excluir uma tela que possui permissões vinculadas',
  'Não é possível excluir uma permissão que está vinculada a cargos':
    'Não é possível excluir uma permissão que está vinculada a cargos',
};
